...
namespace Travelling.Controls
{
    public partial class RouteControl : UserControl
    {
        ...
        private void btnPlanRoute_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(dest) || main.traveler == null)
            {
                MessageBox.Show("Empty traveler or destination field",
            ...
            try
            {
                ...
                {
                    UpdateRouteDisplay("", 0);
                    MessageBox.Show("Destination not reachable or not in map", "Route Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
